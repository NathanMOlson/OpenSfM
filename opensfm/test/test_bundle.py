...
def test_bundle_projection_fixed_internals(
    ...
    reconstruction.bundle(reference, camera_priors, rig_priors, [], custom_config["final_bundle_grid"], custom_config)
...
def test_bundle_void_gps_ignored() -> None:
    ...
    reconstruction.bundle(r, camera_priors, rig_priors, gcp, myconfig["final_bundle_grid"], myconfig)
